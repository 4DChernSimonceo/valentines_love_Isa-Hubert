...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /**
     * Split the message into chunks for the crawl. We split on periods
     * followed by a space to keep sentences together. Each chunk is
     * wrapped in its own paragraph for better readability in the 3D
     * effect. Additional splitting could be applied here if needed
     * to control pacing of the scroll.
     */
